...
import { studentsColumns, studentsData, teachersColumns, teachersData } from '../../utils/mock/tableMockApi';
			...
			<div className={styles.users__wrap}>
				...
				<div className={styles.users__column}>
					<header>
						...
						<Typography.Paragraph className={styles.users__text}>{`${studentsData.length} учащихся`}</Typography.Paragraph>
					...
					<Divider
						className={styles.users__divider}
					/>
					<UsersTable columns={studentsColumns} data={studentsData} showHeader={true} checkbox={true} />
				</div>
			</div>
		</div>
	);

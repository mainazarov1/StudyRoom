import { CaretDownOutlined, CheckOutlined, CloseOutlined, CopyOutlined, SettingOutlined } from '@ant-design/icons';
...
const SettingCourseModal: React.FC = () => {
  ...
  return (
    <>
      ...
      <FullScreenModal
        title={<h2><CloseOutlined onClick={handleChange}  /> Насторйки курса </h2>}
        closebtn={<Button type='primary' onClick={handleChange} style={{marginRight: 24}} >Сохранить</Button>}
        open={open}
      >
          ...
          <div className={s.block} >
            ...
            >
              <div>
                ...
                <p className={s.text} >Настройки влияют и на ссылки для приглашений, и на коды для курсов.</p>
              </div>
                <Button
                  className={s.drop_btn}
                  type='link'
                  icon={
            ...
            >
              ...
              <div>
                <p className={s.text}>https://classroom.google.com/c/NTcwNjUyMjg1OTQ1?cjc=tq7kdvd
                  <CopyOutlined 
                    className={s.icon}
                    onClick={() => 
          ...
          <div className={s.block} > 
            ...
            >
              <div>
                ...
                <p className={s.text} >Выберите систему выставления оценок. Подробнее…</p>
              </div>
              <Select
                size="large"

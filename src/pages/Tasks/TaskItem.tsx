...
const CollapseHead = () => (
  <Row onClick={((e) => console.log(e))} className={s.collapse__head__wrap} justify={'space-between'} align={'middle'}>
    <Row align={'middle'} gutter={16}>
      <Row className={s.collapse__head__icon__wrap}>
        <FileIcon className={s.collapse__head__icon} />
      </Row>
      <Col>
        <Typography.Text className={s.collapse__head__subtitle}>
               Социальная сеть
        </Typography.Text>
      </Col>
      <Space>
    ...
    <Typography.Text className={s.task__points}>
         50
    </Typography.Text>
    <Row gutter={12} align={'middle'}>
      <Col>
        <Typography.Text ellipsis className={s.collapse__head__term}>
               Срок сдачи: 22 июл. 2023 г.
        </Typography.Text>
      </Col>
      <Col onClick={(e) => e.stopPropagation()}>
        <Dropdown placement={'bottomRight'} className={s.collapse__head__dropdown} trigger={['click']} menu={{ items: isTeacher ? taskDropdownTeacher : taskDropdownStudents }}>
...
const TaskItem = () => {
  ...
  return (
    ...
    >
      <Panel className={classNames(s.collapse__panel, key === id ? s.collapse__panel__active : '')} showArrow={false} header={<CollapseHead />} key={'1'} >
        <div className={classNames(s.collapse__content, s.collapse__content__wrap)}>
          <Row>
            <Row style={{
              ...
              <span className={s.task__publication__time}>Опубликовано 10:19</span>
            </Row>
            <Row style={{
              flexGrow: 0,
              flexShrink: 0,
              ...
              <span className={s.task__deadline}>
                        Назначено
              </span>
            </Row>
          </Row>

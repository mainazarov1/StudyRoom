import { Col, Collapse, Dropdown, Row, Space, Typography, type MenuProps } from 'antd';
...
const CollapseHead = () => (
  ...
  >
    <Row align={'middle'} gutter={16}>
      ...
      <Col>
        <Typography.Text className={s.collapse__head__subtitle}>Социальная сеть</Typography.Text>
      </Col>
      <Space>
        <CommentOutlined />
        <span>2</span>
    ...
    <Typography.Text className={s.task__points}>50</Typography.Text>
    ...
    <div className={s.collapse__wrap}>
      <Row className={s.collapse__title__wrap} justify={'space-between'} align={'middle'}>
        <Typography.Title className={s.collapse__title} level={2}>
          <Typography.Link href='#'>Back тестовые задания</Typography.Link>
        </Typography.Title>
        <Dropdown
      ...
      >
        <Panel className={s.collapse__panel} showArrow={false} header={<CollapseHead />} key='1'>
          <div className={classNames(s.collapse__content, s.collapse__content__wrap)}>
            <span>
              Необходимо создать приложение - аналог ленты в социальной сети, которое будет работать
              со специально созданным API. Описание API находится далее по тексту.
              <br />
              <br />
              ...
              которых вы подписаны, в порядке убывания даты (то есть, самые недавние посты должны
              располагаться сверху)
              <br />
              <br />
              Кнопка `&apos;`Редактировать`&apos;` открывает окно редактирования профиля, в него вы
              ...
              <br />
              Нажатие на кнопку `&apos;`Follow user`&apos;` открывает окно ввода e-mail, на которого
              ...
              <br />
              <br />
              Вы можете меняться адресами e-mail с вашими коллегами, и подписываться друг на друга,
              или создать несколько пользователей.Описание API
              <br />
              <br />
              Базовый URL:&nbsp;
              ...
              <br />
              <br />
              Для того, чтобы совершать запросы на API вам потребуется свой адрес электронной почты.
              Он будет служить вашим уникальным идентификатором. Для этого вы добавляете к базовому
              URL свой e-mail, например, таким образом:
              <br />
              <br />
              <a
                target='_blank'
              ...
              профиле. Если вы измените имя и фамилию (см. дальше), будет приходить уже ваша новая
              ...
              Также вы можете отправлять такой POST-запрос без данных, чтобы очистить все подписки
              ...
              <ul>
                ...
                <li>
                  При клике на кнопку `&apos;`Редактировать профиль`&apos;` отобразить окно (попап)
                  с вводом данных (имени и фамилии).
                </li>
                ...
                <li>
                  При клике на кнопку `&apos;`Добавить подписчика`&apos;` отобразить окно (попап) с
                  вводом e-mail
                </li>
          ...
          <div className={classNames(s.collapse__content__wrap)}>Посмотреть задание</div>
        </Panel>
        <Panel showArrow={false} header={<CollapseHead />} key='2'>
          Временный текст
        </Panel>
      </Collapse>
    </div>

  ...
  return (
    <div>
      ...
      <FullScreenModal
        ...
        closebtn={
          <Button type='primary' onClick={handleCancel} style={{ marginRight: 24 }}>
            Присоединиться
          </Button>
        }
        open={isModalOpen}
      >
        ...
        <div className={classNames(s.body_blocks, s.block_text)}>
          ...
          <ul>
            ...
            <li>
              Введите код курса, состоящий из 5–7 букв или цифр. В нем не должно быть пробелов и
              специальных символов.
            </li>
          </ul>
          <p>
            Если вам не удается присоединиться к курсу, прочитайте
            <a href='https://support.google.com/edu/classroom/answer/6020297?hl=ru&authuser=0#zippy=%2Cзабыли-или-потеряли-код-курса%2Cмой-код-курса-не-работает'>
              {' '}
              эту статью.
            </a>
          </p>
